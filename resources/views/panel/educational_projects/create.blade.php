...
<div class="container pt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('messages.New-educational-project') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route("educational_projects.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="link_video" class="form-control @error('link_video') is-invalid @enderror" name="link_video" required autocomplete="link_video" autofocus>{{ old('link_video') }}</textarea>
