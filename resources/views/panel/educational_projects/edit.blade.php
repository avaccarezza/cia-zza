                ...
                <div class="card-body">
                    ...
                    @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="link_video" class="form-control @error('link_video') is-invalid @enderror" name="link_video"  autocomplete="link_video" autofocus>{{ old('link_video') ?? $educational_project->link_video }}</textarea>
