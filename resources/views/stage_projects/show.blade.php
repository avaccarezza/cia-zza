    ...
    <div class="card mb-5 bg-light fadeInUp" style="animation-delay:2ms;">
        <div class="row">
            <div class="col-md-12">
                ...
                <a  class="btn btn-dark m-2" href="{{ $stage_project->link_instagram }}"
                target="_blank">
        ...
        <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
            ...
            <iframe id="projects_video" class="custom-gallery"  width="100%" height="500" src="{{ $stage_project->link_video }}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen="" style="background-color: black;"></iframe> 
    </div>
    </div>
    <div class="col-md-6" id="artistic-{{$stage_project->id}}">
